# Set-Up Your Social Login Application
*******

`src/components/login.jsx`

1) Change the localhost name running Backend in the Login.jsx file to run the application.
...
`{ - Discord CLient Secret & Client ID can be recieved from discord/integrations}`
